...
import com.okta.developer.ADP_Capstone.FormI9.exception.ResourceNotFoundException;
import com.okta.developer.ADP_Capstone.FormI9.repository.FormI9Repository;
...
public class Form_I9Controller {
    ...
    public ResponseEntity<Form_I9> updateForm_I9(@PathVariable long id, @RequestBody Form_I9 form_i9Details) {
        ...
        updateForm_I9.setReviewedBy(form_i9Details.getReviewedBy());
