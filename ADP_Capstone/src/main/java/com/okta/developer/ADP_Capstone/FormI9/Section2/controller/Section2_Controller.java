...
public class Section2_Controller {
    ...
    public Section2_Controller(Section2_Service section2_service, Section_2Repository section_2repository) {
...
*/
    ...
    @GetMapping("/section2")
    public List<Section_2> getSection2(){
        return this.section_2repository.findAll();
    }

    // build create employee REST API
    @PostMapping("/saveSection2")
    public Section_2 completeSection2(@RequestBody Section2_Request request) throws URISyntaxException {
        Section_2 savedSection2= section2_service.setSection2(request);
