...
public class DocumentDAO extends HttpServlet {
	private static final long serialVersionUID = 1L;
		...
		//INPUT DOCUMENT INFO: write method that returns a string. This method will pass the Document object)
		public int InputFile (Document model)
			...
			try {
				...
				PreparedStatement pst= 
						conn.prepareStatement("INSERT INTO documents (ListType, "
								+ "DocumentType, IssuingAuthority, ExpirationDate"
								+ "DocumentPdf) values (?,?,?,?,?)");  //<-- the ???? are placeholders
